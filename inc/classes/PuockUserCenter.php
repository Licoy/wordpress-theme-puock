...
class PuockUserCenter implements IPuockClassLoad
{
    ...
    public static function update_profile()
    {
        ...
        check_ajax_referer('pk_user_update_profile', 'nonce');
    ...
    public static function page_profile()
    {
        ...
        ?>
        <form action="<?php echo esc_url(pk_ajax_url('pk_user_update_profile', ['nonce' => wp_create_nonce('pk_user_update_profile')])) ?>" class="ajax-form" data-no-reset>
            <div class="mb-3 row">
                <label class="col-sm-2 col-form-label">ID</label>
                <div class="col-sm-10">
                    <div class="row align-items-center">
                        <div class="col-4">
                            <input type="text" readonly class="form-control" value="<?php echo esc_attr($userinfo->ID) ?>">
                        </div>
                        <div class="col-8 d-flex">
                            <?php if (current_user_can('administrator')): ?>
                                <a data-no-instant href="<?php echo esc_url(get_admin_url()) ?>" type="button" class="btn btn-ssm btn-primary me-1">
                                    <i class="fa fa-magic"></i>
                                    <span><?php _e('WP后台', PUOCK) ?></span>
                                </a>
                            <?php endif; ?>
                            <button type="button"
                                    onclick="layer.confirm('<?php echo esc_js(__('确认注销登陆吗？', PUOCK)) ?>',function (){window.Puock.goUrl('<?php echo esc_url(wp_logout_url('/')); ?>')})"
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" readonly class="form-control" value="<?php echo esc_attr($userinfo->user_nicename) ?>">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input name="nickname" type="text" class="form-control" value="<?php echo esc_attr($userinfo->nickname) ?>">
                </div>
            </div>
            <div class="mb-3 row">
                <label class="col-sm-2 col-form-label"><?php _e('网站地址', PUOCK) ?></label>
                <div class="col-sm-10">
                    <input name="user_url" type="url" class="form-control" value="<?php echo esc_attr($userinfo->user_url) ?>">
                </div>
            </div>
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <textarea name="description" class="form-control"
                              rows="4"><?php echo esc_textarea($userinfo->description) ?></textarea>
                </div>
            </div>

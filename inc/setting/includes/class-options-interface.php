    ...
    static function optionsframework_tabs()
    {
        ...
        foreach ($options as $value) {
            ...
            if ($value['type'] == "heading") {
                ...
                $menu .= '<a id="options-group-' . $counter . '-tab" class="nav-tab ' . $class . '" href="' . esc_attr('#options-group-' . $counter) . '">' . $value['name'] . '</a>';
            }
        }
        ...
        foreach ($options as $value) {
            ...
            switch ($value['type']) {
                ...
                case 'textarea':
                    ...
                    $val = stripslashes($val);
                    $output .= '<textarea id="' . esc_attr($value['id']) . '" placeholder="' . (isset($value['placeholder']) ? $value['placeholder'] : '') . '" class="of-input" name="' . esc_attr($option_name . '[' . $value['id'] . ']') . '" rows="' . $rows . '"' . $placeholder . '>' . esc_textarea($val) . '</textarea>';
                    break;

...
class ComposerAutoloaderInit4f6b69ae626959092fc09391096ba5a1
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit4f6b69ae626959092fc09391096ba5a1::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire4f6b69ae626959092fc09391096ba5a1($fileIdentifier, $file);
        }
...
function composerRequire4f6b69ae626959092fc09391096ba5a1($fileIdentifier, $file)
{

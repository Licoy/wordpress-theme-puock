                    ...
                    <div class="puock-text no-style">
                        ...
                        <div class="p-block links-main" id="page-links-<?php echo $group['id'] ?>">
                            ...
                            <div class="links-main-box row t-sm">
                                ...
                                <a class="link-item a-link col-lg-3 col-md-4 col-sm-6 col-6" href="<?php echo $use_theme_link_forward ? pk_go_link($link->link_url,$link->link_name) : $link->link_url; ?>" target="<?php echo $link->link_target ?>" rel="<?php echo $link->link_rel ?>" title="<?php echo empty($link->link_notes) ? $link->link_name : $link->link_notes ?>" data-bs-toggle="tooltip">

                    ...
                    <div class="p-block">
                        ...
                        <div class="options p-flex-sbc mt20">
                            <div>
                                ...
                                <div class="option puock-bg ta3 t-sm me-1"><i class="fa-regular fa-eye me-1"></i><span id="post-views"><?php pk_get_post_views();  ?></span><span><?php _e('次阅读', PUOCK) ?></span></div>
                                <?php endif; ?>
                                <a href="#comments"><div class="option puock-bg ta3 t-sm me-1"><i class="fa-regular fa-comment me-1"></i><?php comments_number() ?></div></a>
                                <?php if (is_user_logged_in() && current_user_can('edit_post', $post->ID)): ?>
                                    <a target="_blank" href="<?php echo get_edit_post_link() ?>">
                                        <div class="option puock-bg ta3 t-sm me-1"><i
                                                    class="fa-regular fa-pen-to-square me-1"></i><?php _e('编辑', PUOCK) ?></div>
                                    </a>
                                <?php endif; ?>
                            </div>
                            <?php if(!pk_is_checked("hide_global_sidebar")): ?>
                            <div>
                                <div class="option puock-bg ta3 t-sm me-1 d-none d-lg-inline-block post-main-size"><i class="fa fa-up-right-and-down-left-from-center"></i></div>
                            </div>
                            <?php endif; ?>
                        </div>
